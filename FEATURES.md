...
| dict | 构造、get/set/unset、incr/append/lappend、for/map/filter/update/with | 全部写回异常边界、对象缓存和代表性性能 |
...
| 证据 | 726 本轮 + 248 原有系统 Tcl 场景，两个编译后端，真实宿主及网页验证 | 全量上游测试、跨操作系统、代表性性能和应用迁移 |
