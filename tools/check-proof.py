...
manifest_name=next(name for name in ['number-dispatch-upgrade.json','conversion-upgrade.json','unicode-upgrade.json','syntax-upgrade.json','completion-upgrade.json','namespace-upgrade.json','performance-upgrade.json','semantic-upgrade.json'] if (root/'evidence'/name).exists())
