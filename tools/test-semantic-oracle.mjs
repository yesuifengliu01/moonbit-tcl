...
if(!['semantic','cache','namespace','completion','syntax','unicode'].includes(suite))throw new Error('suite must be semantic, cache, namespace, completion, syntax or unicode');
