...
if(!['semantic','cache','namespace','completion','syntax','unicode','conversion'].includes(suite))throw new Error('suite must be semantic, cache, namespace, completion, syntax, unicode or conversion');
