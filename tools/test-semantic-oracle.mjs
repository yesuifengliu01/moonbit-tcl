...
if(!['semantic','cache','namespace','completion','syntax','unicode','conversion','value','switch','regexp','search','sort'].includes(suite))throw new Error('suite must be semantic, cache, namespace, completion, syntax, unicode, conversion, value, switch, regexp, search or sort');
