...
if(!['semantic','cache','namespace','completion','syntax','unicode','conversion','value'].includes(suite))throw new Error('suite must be semantic, cache, namespace, completion, syntax, unicode, conversion or value');
