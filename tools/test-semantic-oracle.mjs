...
const reference=JSON.parse(fs.readFileSync(new URL('../evidence/semantic-reference.json',import.meta.url),'utf8'));
...
fs.writeFileSync(new URL('../evidence/semantic-comparison.json',import.meta.url),JSON.stringify(report,null,2)+'\n');
