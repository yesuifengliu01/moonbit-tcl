...
function _M0TPB3MapGsRP211localreview3tcl4CellE(param0, param1, param2, param3, param4, param5, param6) {
  this.entries = param0;
  this.size = param1;
...
function _M0TPB5EntryGsRP211localreview3tcl9ProcedureE(param0, param1, param2, param3, param4, param5) {
  this.prev = param0;
  this.next = param1;
  this.psl = param2;
  this.hash = param3;
...
_M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid.prototype.$tag = 3;
function _M0DTPC15error5Error37localreview_2ftcl_2eTclError_2eReturn(param0) {
  this._0 = param0;
}
_M0DTPC15error5Error37localreview_2ftcl_2eTclError_2eReturn.prototype.$tag = 2;
function _M0DTPC15error5Error36localreview_2ftcl_2eTclError_2eBreak() {}
_M0DTPC15error5Error36localreview_2ftcl_2eTclError_2eBreak.prototype.$tag = 1;
...
_M0DTPC15error5Error39localreview_2ftcl_2eTclError_2eContinue.prototype.$tag = 0;
...
_M0DTP211localreview3tcl13VariableValue8Elements.prototype.$tag = 1;
...
_M0DTP211localreview3tcl6Number5Whole.prototype.$tag = 0;
function _M0DTP211localreview3tcl6Number4Real(param0) {
  this._0 = param0;
}
_M0DTP211localreview3tcl6Number4Real.prototype.$tag = 1;
...
function _M0DTPC16result6ResultGRPB5ArrayGRPB5ArrayGRP211localreview3tcl4WordEERP211localreview3tcl8TclErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRPB5ArrayGRP211localreview3tcl4WordEERP211localreview3tcl8TclErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRPB5ArrayGRPB5ArrayGRP211localreview3tcl4WordEERP211localreview3tcl8TclErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRPB5ArrayGRP211localreview3tcl4WordEERP211localreview3tcl8TclErrorE2Ok.prototype.$tag = 1;
...
function _M0TP211localreview3tcl12ScriptParser(param0, param1) {
  this.chars = param0;
  this.pos = param1;
}
...
function _M0TP211localreview3tcl5State(param0, param1, param2, param3) {
  this.globals = param0;
  this.aliases = param1;
  this.procedures = param2;
  this.namespaces = param3;
}
...
function _M0TPB9ArrayViewGUsRP211localreview3tcl9ProcedureEE(param0, param1, param2) {
  this.buf = param0;
  this.start = param1;
  this.end = param2;
}
...
function _M0MPC15array5Array4pushGRPB5ArrayGRP211localreview3tcl4WordEE(self, value) {
  _M0MPB7JSArray4push(self, value);
}
...
function _M0FPB8new__mapGsRP211localreview3tcl4CellE(capacity) {
  ...
  return new _M0TPB3MapGsRP211localreview3tcl4CellE(_bind$4, 0, capacity$2, _bind$2, _bind$3, _bind$5, -1);
}
...
function _M0MPB3Map20add__entry__to__tailGsRP211localreview3tcl4CellE(self, idx, entry) {
  const _bind$2 = self.tail;
  if (_bind$2 === -1) {
    self.head = entry;
  } else {
...
function _M0MPB3Map10set__entryGsRP211localreview3tcl4CellE(self, entry, new_idx) {
  const _bind$2 = entry.next;
  if (_bind$2 === undefined) {
    self.tail = new_idx;
  } else {
...
function _M0MPB3Map10push__awayGsRP211localreview3tcl4CellE(self, idx, entry) {
  let _tmp = entry.psl + 1 | 0;
  let _tmp$2 = (idx + 1 | 0) & self.capacity_mask;
  let _tmp$3 = entry;
  while (true) {
    ...
    if (_bind$2 === undefined) {
      entry$2.psl = psl;
      _M0MPB3Map10set__entryGsRP211localreview3tcl4CellE(self, entry$2, idx$2);
      return;
    } else {
      const _Some = _bind$2;
      const _curr_entry = _Some;
...
function _M0MPB3Map20rehash__place__entryGsRP211localreview3tcl4CellE(self, outer) {
  const hash = outer.hash;
  let _tmp = 0;
  let _tmp$2 = hash & self.capacity_mask;
  while (true) {
    ...
    if (_bind$2 === undefined) {
      outer.psl = psl;
      outer.prev = self.tail;
      _M0MPB3Map20add__entry__to__tailGsRP211localreview3tcl4CellE(self, idx, outer);
      return undefined;
    } else {
      const _Some = _bind$2;
      const _curr = _Some;
      if (psl > _curr.psl) {
        _M0MPB3Map10push__awayGsRP211localreview3tcl4CellE(self, idx, _curr);
        outer.psl = psl;
        outer.prev = self.tail;
        _M0MPB3Map20add__entry__to__tailGsRP211localreview3tcl4CellE(self, idx, outer);
        return undefined;
...
function _M0MPB3Map4growGsRP211localreview3tcl4CellE(self) {
  const old_head = self.head;
  const new_capacity = self.capacity << 1;
  self.entries = $make_array_len_and_init(new_capacity, undefined);
  self.capacity = new_capacity;
  ...
  while (true) {
    ...
    if (x === undefined) {
      ...
      const next_in_chain = _e.next;
      _e.next = undefined;
      _M0MPB3Map20rehash__place__entryGsRP211localreview3tcl4CellE(self, _e);
      _tmp = next_in_chain;
      continue;
    }
  }
...
function _M0MPB3Map15set__with__hashGsRP211localreview3tcl4CellE(self, key, value, hash) {
  ...
  while (true) {
    ...
    if (_bind$2 === undefined) {
      if (self.size >= self.grow_at) {
        _M0MPB3Map4growGsRP211localreview3tcl4CellE(self);
        _tmp = 0;
        _tmp$2 = hash & self.capacity_mask;
        continue;
      }
      ...
      _M0MPB3Map20add__entry__to__tailGsRP211localreview3tcl4CellE(self, idx, entry);
      return undefined;
    } else {
      const _Some = _bind$2;
      const _curr_entry = _Some;
      ...
      if (psl > _curr_entry.psl) {
        ...
        _M0MPB3Map10push__awayGsRP211localreview3tcl4CellE(self, idx, _curr_entry);
        const _bind$3 = self.tail;
        const _bind$4 = undefined;
        const entry = new _M0TPB5EntryGsRP211localreview3tcl4CellE(_bind$3, _bind$4, psl, hash, key, value);
        _M0MPB3Map20add__entry__to__tailGsRP211localreview3tcl4CellE(self, idx, entry);
...
function _M0MPB3Map15set__with__hashGsRP211localreview3tcl9ProcedureE(self, key, value, hash) {
  let _tmp = 0;
  let _tmp$2 = hash & self.capacity_mask;
  while (true) {
    const psl = _tmp;
    ...
    if (_bind$2 === undefined) {
      ...
      const _bind$3 = self.tail;
      const _bind$4 = undefined;
      const entry = new _M0TPB5EntryGsRP211localreview3tcl9ProcedureE(_bind$3, _bind$4, psl, hash, key, value);
      _M0MPB3Map20add__entry__to__tailGsRP211localreview3tcl4CellE(self, idx, entry);
      return undefined;
    } else {
      const _Some = _bind$2;
...
function _M0MPB3Map3setGsRP211localreview3tcl9ProcedureE(self, key, value) {
  _M0MPB3Map15set__with__hashGsRP211localreview3tcl9ProcedureE(self, key, value, _M0IPC16string6StringPB4Hash4hash(key));
}
...
function _M0MPB3Map3MapGsRP211localreview3tcl4CellE(arr, capacity) {
  ...
  const m = _M0FPB8new__mapGsRP211localreview3tcl4CellE(capacity$2);
...
function _M0MPB3Map3MapGsRP211localreview3tcl9ProcedureE(arr, capacity) {
  const length = arr.end - arr.start | 0;
  let capacity$2;
  if (capacity === undefined) {
    capacity$2 = length === 0 ? 8 : _M0FPB21capacity__for__length(length);
  ...
  while (true) {
    ...
    if (_ < _bind$2) {
      const e = arr.buf[arr.start + _ | 0];
      _M0MPB3Map3setGsRP211localreview3tcl9ProcedureE(m, e._0, e._1);
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0MPB3Map3getGsRP211localreview3tcl9ProcedureE(self, key) {
...
function _M0MPB3Map8containsGsRP211localreview3tcl9ProcedureE(self, key) {
  const hash = _M0IPC16string6StringPB4Hash4hash(key);
  let _tmp = 0;
  let _tmp$2 = hash & self.capacity_mask;
  while (true) {
...
function _M0MPB3Map13remove__entryGsRP211localreview3tcl9ProcedureE(self, entry) {
  const _bind$2 = entry.prev;
  if (_bind$2 === -1) {
    self.head = entry.next;
  } else {
...
function _M0MPB3Map11shift__backGsRP211localreview3tcl9ProcedureE(self, idx) {
  let _tmp = idx;
  while (true) {
    const cur = _tmp;
    const next = (cur + 1 | 0) & self.capacity_mask;
    _L: {
      ...
      if (_bind$2 === undefined) {
        ...
        if (_x$2 === 0) {
          ...
          _x.psl = _x.psl - 1 | 0;
          _M0MPB3Map10set__entryGsRP211localreview3tcl4CellE(self, _x, cur);
          _tmp = next;
          continue;
        }
      }
...
function _M0MPB3Map18remove__with__hashGsRP211localreview3tcl9ProcedureE(self, key, hash) {
  let _tmp = 0;
  let _tmp$2 = hash & self.capacity_mask;
  while (true) {
    const i = _tmp;
    ...
    if (_bind$2 === undefined) {
      ...
      const _entry = _Some;
      if (_entry.hash === hash && _entry.key === key) {
        _M0MPB3Map13remove__entryGsRP211localreview3tcl9ProcedureE(self, _entry);
        _M0MPB3Map11shift__backGsRP211localreview3tcl9ProcedureE(self, idx);
        self.size = self.size - 1 | 0;
        return;
      }
      if (i > _entry.psl) {
...
function _M0MPB3Map6removeGsRP211localreview3tcl9ProcedureE(self, key) {
  _M0MPB3Map18remove__with__hashGsRP211localreview3tcl9ProcedureE(self, key, _M0IPC16string6StringPB4Hash4hash(key));
}
...
function _M0MPC15array5Array9is__emptyGRPB5ArrayGRP211localreview3tcl4WordEE(self) {
...
function _M0IP211localreview3tcl8TclErrorPC15debug5Debug8to__repr(_x_804) {
  let _arg_806;
  _L: {
    let _arg_805;
    _L$2: {
      switch (_x_804.$tag) {
        case 3: {
          const _Invalid = _x_804;
          const _$42$arg_805 = _Invalid._0;
          _arg_805 = _$42$arg_805;
          break _L$2;
        }
        case 2: {
          const _Return = _x_804;
          const _$42$arg_806 = _Return._0;
          _arg_806 = _$42$arg_806;
          break _L;
        }
        case 1: {
    ...
    return _M0MPC15debug4Repr4ctor("Invalid", [{ _0: undefined, _1: _M0IPC16string6StringPC15debug5Debug8to__repr(_arg_805) }]);
  }
  return _M0MPC15debug4Repr4ctor("Return", [{ _0: undefined, _1: _M0IPC16string6StringPC15debug5Debug8to__repr(_arg_806) }]);
}
function _M0FP211localreview3tcl15qualified__name(prefix, name) {
  ...
  const _bind$3 = "::";
  const _tmp = _M0MPB4Iter9to__arrayGRPC16string10StringViewE(_M0MPB4Iter6filterGRPC16string10StringViewE(_M0MPC16string6String5split(normalized, new _M0TPC16string10StringView(_bind$3, 0, _bind$3.length)), (s) => !_M0MPC16string10StringView9is__empty(s)));
  const _bind$4 = "::";
  return `::${_M0MPC15array5Array4joinGRPC16string10StringViewE(_tmp, new _M0TPC16string10StringView(_bind$4, 0, _bind$4.length))}`;
}
function _M0FP211localreview3tcl17namespace__parent(name) {
  const _bind$2 = "::";
  const parts = _M0MPB4Iter9to__arrayGRPC16string10StringViewE(_M0MPB4Iter6filterGRPC16string10StringViewE(_M0MPC16string6String5split(name, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length)), (s) => !_M0MPC16string10StringView9is__empty(s)));
  if (parts.length < 2) {
    return "::";
  } else {
...
function _M0FP211localreview3tcl15variable__parts(name) {
  ...
  while (true) {
    if (at.val < chars.length && _M0MPC15array5Array2atGcE(chars, at.val) !== 40) {
      at.val = at.val + 1 | 0;
      continue;
    } else {
      break;
  ...
  if (_tmp) {
    return { _0: _M0MPC16string6String11from__array(_M0MPC15array5Array12view_2einnerGcE(chars, 0, at.val)), _1: _M0MPC16string6String11from__array(_M0MPC15array5Array12view_2einnerGcE(chars, at.val + 1 | 0, chars.length - 1 | 0)) };
  } else {
...
function _M0MP211localreview3tcl11Interpreter7binding(self, name, create) {
  ...
  if (!_M0MPC16string6String8contains(base, new _M0TPC16string10StringView(_bind$3, 0, _bind$3.length))) {
    _tmp$2 = !_M0MP211localreview3tcl11Interpreter15global__defined(self, key.val) && _M0MP211localreview3tcl11Interpreter15global__defined(self, `::${base}`);
  } else {
    _tmp$2 = false;
  }
  if (_tmp$2) {
  ...
  _L$2: {
    _L$3: {
      const _bind$4 = _M0MPB3Map3getGsRP211localreview3tcl7BindingE(self.state.aliases, key.val);
      if (_bind$4 === undefined) {
      } else {
        const _Some = _bind$4;
        const _binding = _Some;
  ...
  let cell;
  const _bind$4 = _M0MPB3Map3getGsRP211localreview3tcl4CellE(self.state.globals, key.val);
  if (_bind$4 === undefined) {
    if (!create) {
      return new _M0DTPC16result6ResultGORP211localreview3tcl7BindingRP211localreview3tcl8TclErrorE2Ok(undefined);
    }
...
function _M0MP211localreview3tcl7Binding4read(self) {
  ...
  _L: {
    ...
    return new _M0DTPC16result6ResultGOsRP211localreview3tcl8TclErrorE2Ok(value);
  }
...
function _M0MP211localreview3tcl11Interpreter9read__var(self, name) {
  let value;
  _L: {
    const _bind$2 = _M0MP211localreview3tcl11Interpreter8get__var(self, name);
    let _bind$3;
    if (_bind$2.$tag === 1) {
      const _ok = _bind$2;
      _bind$3 = _ok._0;
    ...
    if (_bind$3 === undefined) {
      return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid(`undefined variable ${name}`));
    } else {
      const _Some = _bind$3;
      const _value = _Some;
      value = _value;
...
function _M0MP211localreview3tcl11Interpreter8set__var(self, name, value) {
  ...
  if (_M0MPB3Map6lengthGssE(values) >= 10000 && !_M0MPB3Map8containsGssE(values, index)) {
...
function _M0MP211localreview3tcl11Interpreter15find__procedure(self, name) {
  const key = _M0FP211localreview3tcl15qualified__name(self.frame.namespace_name, name);
  if (_M0MPB3Map8containsGsRP211localreview3tcl9ProcedureE(self.state.procedures, key)) {
    return key;
  } else {
    let _tmp;
    const _bind$2 = "::";
    if (!_M0MPC16string6String11has__prefix(name, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length))) {
      _tmp = _M0MPB3Map8containsGsRP211localreview3tcl9ProcedureE(self.state.procedures, _M0FP211localreview3tcl15qualified__name("::", name));
    } else {
      _tmp = false;
    }
    if (_tmp) {
      return _M0FP211localreview3tcl15qualified__name("::", name);
    } else {
      return undefined;
    }
  }
...
function _M0FP211localreview3tcl14builtin__names() {
  return ["set", "unset", "incr", "append", "expr", "puts", "if", "proc", "return", "list", "llength", "lindex", "lappend", "join", "split", "concat", "lrange", "lreverse", "lrepeat", "lset", "linsert", "lreplace", "lsearch", "lsort", "while", "for", "foreach", "lmap", "break", "continue", "catch", "error", "namespace", "global", "variable", "upvar", "uplevel", "array", "dict", "string", "info", "eval", "subst", "rename"];
}
function _M0FP211localreview3tcl13builtin__name(name) {
  return _M0MPC15array5Array8containsGsE(_M0FP211localreview3tcl14builtin__names(), name);
}
...
function _M0FP211localreview3tcl6number(text) {
  ...
  _L: {
    ...
    return new _M0DTP211localreview3tcl6Number5Whole(value);
  }
  const text$2 = _M0MPC16string10StringView9to__owned(_M0MPC16string6String4trim(text, undefined));
  ...
  _L$2: {
    switch (op) {
      ...
      case "size": {
        ...
        return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE2Ok(_M0MPC13int3Int18to__string_2einner(_M0MPC16option6Option10unwrap__orGiE(_M0MPC16option6Option3mapGRPB3MapGssEiE(values, (v) => _M0MPB3Map6lengthGssE(v)), 0), 10));
      }
      case "set": {
        if (n !== 4) {
        ...
        while (true) {
          if (i.val < pairs.length) {
            if (_M0MPB3Map6lengthGssE(values$2) >= 10000 && !_M0MPB3Map8containsGssE(values$2, _M0MPC15array5Array2atGRPB4JsonE(pairs, i.val))) {
...
function _M0MP211localreview3tcl6Number4text(self) {
  ...
  if (_M0MPC16double6Double7is__nan(value)) {
    return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid("domain error: argument not in valid range"));
  }
...
function _M0FP211localreview3tcl15numeric__binary(operator, left, right) {
  ...
  if (_M0MPC15array5Array8containsGsE(["==", "!=", "<", ">", "<=", ">="], operator)) {
    ...
    _L: {
        ...
        _L$3: {
          _L$4: {
            ...
            _L$5: {
              _L$6: {
                ...
                _L$7: {
                  _L$8: {
                    ...
                    comparison = _M0IPC16bigint6BigIntPB7Compare7compare(a$5, b$5);
                    break _L$7;
                  }
                  if (_M0MPC16double6Double7is__nan(b$4)) {
                    return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE2Ok(_M0FP211localreview3tcl13boolean__text(operator === "!="));
                  }
                  const _bind$2 = _M0FP211localreview3tcl24integer__double__compare(a$4, b$4);
                  if (_bind$2.$tag === 1) {
                    const _ok = _bind$2;
                    comparison = _ok._0;
                  } else {
              ...
              if (_M0MPC16double6Double7is__nan(a$3)) {
                return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE2Ok(_M0FP211localreview3tcl13boolean__text(operator === "!="));
              }
              const _bind$2 = _M0FP211localreview3tcl24integer__double__compare(b$3, a$3);
              let _tmp;
              if (_bind$2.$tag === 1) {
                const _ok = _bind$2;
                _tmp = _ok._0;
          ...
          const x = _M0MP211localreview3tcl6Number6double(a$2);
          const y = _M0MP211localreview3tcl6Number6double(b$2);
          if (_M0MPC16double6Double7is__nan(x) || _M0MPC16double6Double7is__nan(y)) {
            return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE2Ok(_M0FP211localreview3tcl13boolean__text(operator === "!="));
          }
      ...
      comparison = _M0IPC16string6StringPB7Compare7compare(left, right);
    }
    let _tmp;
    switch (operator) {
      case "==": {
  ...
  _L: {
    ...
    _L$4: {
      ...
      _L$6: {
        _L$7: {
          switch (operator) {
            case "+": {
              value = _M0IPC16bigint6BigIntPB3Add3add(x, y);
              break;
            }
            case "-": {
              value = _M0IPC16bigint6BigIntPB3Sub3sub(x, y);
              break;
            }
            case "*": {
              if ((_M0MPC16bigint6BigInt11bit__length(x) + _M0MPC16bigint6BigInt11bit__length(y) | 0) > 16384) {
                return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid("integer bit limit"));
              }
              value = _M0IPC16bigint6BigIntPB3Mul3mul(x, y);
              break;
            }
            case "%": {
              if (_M0IPC16bigint6BigIntPB2Eq5equal(y, 0n)) {
                return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid("divide by zero"));
              }
              const r = _M0IPC16bigint6BigIntPB3Mod3mod(x, y);
              value = _M0IP016_24default__implPB2Eq10not__equalGRPC16bigint6BigIntE(r, 0n) && _M0IP016_24default__implPB2Eq10not__equalGbE(_M0IP016_24default__implPB7Compare6op__ltGRPC16bigint6BigIntE(r, 0n), _M0IP016_24default__implPB7Compare6op__ltGRPC16bigint6BigIntE(y, 0n)) ? _M0IPC16bigint6BigIntPB3Add3add(r, y) : r;
              break;
            }
            case "**": {
              if (_M0IP016_24default__implPB7Compare6op__ltGRPC16bigint6BigIntE(y, 0n)) {
                if (_M0IPC16bigint6BigIntPB2Eq5equal(x, 0n)) {
                  return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid("exponentiation of zero by negative power"));
                }
                value = _M0IPC16bigint6BigIntPB2Eq5equal(x, 1n) ? 1n : _M0IPC16bigint6BigIntPB2Eq5equal(x, _M0IPC16bigint6BigIntPB3Neg3neg(1n)) ? (_M0IPC16bigint6BigIntPB2Eq5equal(_M0IPC16bigint6BigIntPB3Mod3mod(y, 2n), 0n) ? 1n : _M0IPC16bigint6BigIntPB3Neg3neg(1n)) : 0n;
              } else {
                let _tmp;
                if (_M0IP016_24default__implPB7Compare6op__gtGRPC16bigint6BigIntE(y, 16384n)) {
                  _tmp = true;
                } else {
                  let _tmp$2;
                  if (_M0MPC16bigint6BigInt11bit__length(x) > 1) {
                    const _tmp$3 = _M0MPC16bigint6BigInt11bit__length(x);
                    if (_tmp$3 === 0) {
                      $panic();
                    }
                    _tmp$2 = _M0IP016_24default__implPB7Compare6op__gtGRPC16bigint6BigIntE(y, _M0MPC16bigint6BigInt9from__int(16384 / _tmp$3 | 0));
                  } else {
                    _tmp$2 = false;
                  }
                  _tmp = _tmp$2;
                ...
                value = _M0MPC16bigint6BigInt3pow(x, y, _M0DTPC16option6OptionGRPC16bigint6BigIntE4None__);
              }
              break;
            }
            case "<<": {
            ...
            case "&": {
              value = _M0IPC16bigint6BigIntPB6BitAnd4land(x, y);
              break;
            }
            case "|": {
              value = _M0IPC16bigint6BigIntPB5BitOr3lor(x, y);
              break;
            }
            case "^": {
              value = _M0IPC16bigint6BigIntPB6BitXOr4lxor(x, y);
              break;
            }
            default: {
        ...
        if (_M0IP016_24default__implPB7Compare6op__ltGRPC16bigint6BigIntE(y, 0n) || _M0IP016_24default__implPB7Compare6op__gtGRPC16bigint6BigIntE(y, 16384n)) {
        ...
        if (operator === "<<") {
          if ((_M0MPC16bigint6BigInt11bit__length(x) + _M0MPC16bigint6BigInt7to__int(y) | 0) > 16384) {
            return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid("integer bit limit"));
          }
          value = _M0IPC16bigint6BigIntPB3Shl3shl(x, _M0MPC16bigint6BigInt7to__int(y));
        } else {
          value = _M0IPC16bigint6BigIntPB3Shr3shr(x, _M0MPC16bigint6BigInt7to__int(y));
        }
      }
    ...
    const x$2 = _M0MP211localreview3tcl6Number6double(a$2);
    const y$2 = _M0MP211localreview3tcl6Number6double(b$2);
    let result;
    switch (operator) {
      case "+": {
        result = x$2 + y$2;
      ...
      case "**": {
        result = _M0FPC14math3pow(x$2, y$2);
        break;
      }
      default: {
...
function _M0FP211localreview3tcl15numeric__divide(left, right) {
  _L: {
    ...
    let y;
    _L$2: {
      const _bind$2 = _M0FP211localreview3tcl6number(left);
      const _bind$3 = _M0FP211localreview3tcl6number(right);
      if (_bind$2 === undefined) {
        break _L;
      } else {
        const _Some = _bind$2;
...
function _M0MP211localreview3tcl12ScriptParser14script_2einner(self, bracket, depth, one) {
  if (depth > 64) {
    return new _M0DTPC16result6ResultGRPB5ArrayGRPB5ArrayGRP211localreview3tcl4WordEERP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid("script nesting limit"));
  }
  const commands = [];
    ...
    if (self.pos < self.chars.length) {
      ...
      if (c === 93 && bracket) {
        ...
        if (!_M0MPC15array5Array9is__emptyGRPB4JsonE(words.val)) {
          _M0MPC15array5Array4pushGRPB5ArrayGRP211localreview3tcl4WordEE(commands, words.val);
        }
        return new _M0DTPC16result6ResultGRPB5ArrayGRPB5ArrayGRP211localreview3tcl4WordEERP211localreview3tcl8TclErrorE2Ok(commands);
      }
      ...
      if (c === 59 || c === 10) {
        ...
        if (one && !_M0MPC15array5Array9is__emptyGRPB5ArrayGRP211localreview3tcl4WordEE(commands)) {
          return new _M0DTPC16result6ResultGRPB5ArrayGRPB5ArrayGRP211localreview3tcl4WordEERP211localreview3tcl8TclErrorE2Ok(commands);
        }
      } else {
        if (_M0FP211localreview3tcl11list__space(c)) {
          ...
          if (c === 35 && _M0MPC15array5Array9is__emptyGRPB4JsonE(words.val)) {
            ...
            if (words.val.length > 4096) {
              return new _M0DTPC16result6ResultGRPB5ArrayGRPB5ArrayGRP211localreview3tcl4WordEERP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid("command argument limit"));
            }
          }
        }
      }
      if (commands.length > 10000) {
        return new _M0DTPC16result6ResultGRPB5ArrayGRPB5ArrayGRP211localreview3tcl4WordEERP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid("script command limit"));
      }
      continue;
    } else {
      break;
  ...
  if (bracket) {
    return new _M0DTPC16result6ResultGRPB5ArrayGRPB5ArrayGRP211localreview3tcl4WordEERP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid("missing close-bracket"));
  }
  if (!_M0MPC15array5Array9is__emptyGRPB4JsonE(words.val)) {
    _M0MPC15array5Array4pushGRPB5ArrayGRP211localreview3tcl4WordEE(commands, words.val);
  }
  ...
  while (true) {
    if (i.val < words.length) {
      ...
      _L: {
        ...
        _M0MPC15array5Array3setGsE(result, index, { _0: _M0MPC15array5Array2atGRPB4JsonE(words, i.val), _1: _M0MPC15array5Array2atGRPB4JsonE(words, i.val + 1 | 0) });
      }
      i.val = i.val + 2 | 0;
      continue;
    } else {
...
function _M0FP211localreview3tcl16dictionary__edit(text, keys, value, depth) {
  ...
  _L: {
    ...
    if (index.val < 0) {
      ...
      _M0MPC15array5Array3setGsE(pairs, index.val, { _0: _M0MPC15array5Array2atGRPB4JsonE(keys, 0), _1: v });
    }
  }
...
function _M0FP211localreview3tcl13sort__strings(values, compare) {
  const buffer = _M0MPC15array5Array4copyGsE(values);
...
function _M0MP211localreview3tcl11Interpreter13info__command(self, args) {
  ...
  _L: {
    _L$2: {
      _L$3: {
        ...
        switch (_bind$2) {
          ...
          case "patchlevel": {
            ...
            return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE2Ok("0.4.0");
          }
          case "tclversion": {
            if (n !== 2) {
      ...
      if (self.frame.procedure && _M0IP016_24default__implPB2Eq10not__equalGsE(_M0MPC15array5Array2atGRPB4JsonE(args, 1), "globals")) {
        const _it = _M0MPB3Map5iter2GssE(self.frame.vars);
        while (true) {
          let key;
          let binding;
          _L$4: {
        ...
        const _it = _M0MPB3Map5iter2GssE(self.state.globals);
        while (true) {
          let key;
          let cell;
          _L$4: {
        ...
        const _it$2 = _M0MPB3Map5iter2GssE(self.state.aliases);
        while (true) {
          let key;
          let binding;
          _L$4: {
            const _bind$2 = _M0MPB5Iter24nextGssE(_it$2);
            if (_bind$2 === undefined) {
              break;
            } else {
              const _Some = _bind$2;
    ...
    const values = _M0MPC15array5Array2atGRPB4JsonE(args, 1) === "commands" ? _M0FP211localreview3tcl14builtin__names() : [];
    const _it = _M0MPB3Map5iter2GssE(self.state.procedures);
    while (true) {
      let key;
      _L$3: {
        const _bind$2 = _M0MPB5Iter24nextGssE(_it);
      ...
      if (_M0FP211localreview3tcl17namespace__parent(key) === self.frame.namespace_name) {
        _M0MPC15array5Array4pushGRPC14json10WriteFrameE(values, _M0FP211localreview3tcl15namespace__tail(key));
      }
      continue;
    }
  ...
  const key = _M0MPC16option6Option10unwrap__orGsE(_M0MP211localreview3tcl11Interpreter15find__procedure(self, _M0MPC15array5Array2atGRPB4JsonE(args, 2)), "");
  let definition;
  const _bind$2 = _M0MPB3Map3getGsRP211localreview3tcl9ProcedureE(self.state.procedures, key);
  if (_bind$2 === undefined) {
...
function _M0MP211localreview3tcl11Interpreter13list__command(self, args) {
  const n = args.length;
  ...
  switch (_bind$2) {
    ...
    case "lappend": {
      ...
      const _bind$6 = _M0FP211localreview3tcl11parse__list(_M0MPC16option6Option10unwrap__orGsE(_tmp$3, ""));
      let values;
      if (_bind$6.$tag === 1) {
        const _ok = _bind$6;
        values = _ok._0;
      ...
      while (true) {
        const _ = _tmp$4;
        if (_ < _bind$8) {
          const item = _bind$7.buf[_bind$7.start + _ | 0];
          _M0MPC15array5Array4pushGRPC14json10WriteFrameE(values, item);
          _tmp$4 = _ + 1 | 0;
          continue;
        } else {
          break;
      ...
      const _bind$9 = _M0FP211localreview3tcl12format__list(values);
      let result;
      if (_bind$9.$tag === 1) {
        const _ok = _bind$9;
        result = _ok._0;
      ...
      const _bind$10 = _M0MP211localreview3tcl11Interpreter8set__var(self, _M0MPC15array5Array2atGRPB4JsonE(args, 1), result);
      if (_bind$10.$tag === 1) {
        const _ok = _bind$10;
        _ok._0;
      } else {
    ...
    case "join": {
      ...
      const _bind$11 = _M0FP211localreview3tcl11parse__list(_M0MPC15array5Array2atGRPB4JsonE(args, 1));
      let values$2;
      if (_bind$11.$tag === 1) {
        const _ok = _bind$11;
        values$2 = _ok._0;
      ...
      const size = new _M0TPB8MutLocalGiE(0);
      const _bind$12 = values$2.length;
      let _tmp$5 = 0;
      while (true) {
        const _ = _tmp$5;
        if (_ < _bind$12) {
      ...
      if (values$2.length > 1) {
        const _tmp$7 = sep.length;
        const _tmp$8 = values$2.length - 1 | 0;
        if (_tmp$8 === 0) {
          $panic();
        }
        _tmp$6 = _tmp$7 > ((1000000 - size.val | 0) / _tmp$8 | 0);
      } else {
        _tmp$6 = false;
      }
      if (_tmp$6) {
      ...
      return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE2Ok(_M0MPC15array5Array4joinGsE(values$2, new _M0TPC16string10StringView(sep, 0, sep.length)));
    }
    case "split": {
      if (n !== 2 && n !== 3) {
      ...
      if (_M0MPC15array5Array9is__emptyGcE(separators)) {
        const _bind$13 = chars.length;
        let _tmp$7 = 0;
        while (true) {
          const _ = _tmp$7;
          if (_ < _bind$13) {
            const c = chars[_];
            _M0MPC15array5Array4pushGRPC14json10WriteFrameE(values$3, _M0IPC14char4CharPB4Show10to__string(c));
            _tmp$7 = _ + 1 | 0;
            continue;
          } else {
            break;
          ...
          while (true) {
            ...
            if (_ < _bind$13) {
              ...
              if (_M0MPC15array5Array8containsGcE(separators, c)) {
                _M0MPC15array5Array4pushGRPC14json10WriteFrameE(values$3, word.val);
                word.val = "";
              } else {
      ...
      return _M0FP211localreview3tcl12format__list(values$3);
    }
    case "concat": {
      const values$4 = [];
      const size$2 = new _M0TPB8MutLocalGiE(0);
      const _bind$13 = _M0MPC15array5Array12view_2einnerGsE(args, 1, undefined);
      const _bind$14 = _bind$13.end - _bind$13.start | 0;
      let _tmp$7 = 0;
      while (true) {
        const _ = _tmp$7;
        if (_ < _bind$14) {
          const part = _bind$13.buf[_bind$13.start + _ | 0];
          ...
          if (first.val < last.val) {
            ...
            _M0MPC15array5Array4pushGRPC14json10WriteFrameE(values$4, value$2);
          }
          _tmp$7 = _ + 1 | 0;
          continue;
        } else {
      ...
      const _bind$15 = " ";
      return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE2Ok(_M0MPC15array5Array4joinGsE(values$4, new _M0TPC16string10StringView(_bind$15, 0, _bind$15.length)));
    }
    case "lrange": {
      if (n !== 4) {
      ...
      const _bind$16 = _M0FP211localreview3tcl11parse__list(_M0MPC15array5Array2atGRPB4JsonE(args, 1));
      let values$5;
      if (_bind$16.$tag === 1) {
        const _ok = _bind$16;
        values$5 = _ok._0;
      ...
      const _bind$17 = _M0FP211localreview3tcl11list__index(_M0MPC15array5Array2atGRPB4JsonE(args, 2), values$5.length);
      let _tmp$8;
      if (_bind$17.$tag === 1) {
        const _ok = _bind$17;
        _tmp$8 = _ok._0;
      ...
      const first = _M0MPC13int3Int3max(_tmp$8, 0);
      const _bind$18 = _M0FP211localreview3tcl11list__index(_M0MPC15array5Array2atGRPB4JsonE(args, 3), values$5.length);
      let _tmp$9;
      if (_bind$18.$tag === 1) {
        const _ok = _bind$18;
        _tmp$9 = _ok._0;
      ...
      const last = _M0MPC13int3Int3min(_tmp$9, values$5.length - 1 | 0);
      return first > last ? new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE2Ok("") : _M0FP211localreview3tcl12format__list(_M0MPC15array9ArrayView9to__ownedGsE(_M0MPC15array5Array12view_2einnerGsE(values$5, first, last + 1 | 0)));
    }
    case "lreverse": {
      if (n !== 2) {
      ...
      const _bind$19 = _M0FP211localreview3tcl11parse__list(_M0MPC15array5Array2atGRPB4JsonE(args, 1));
      let values$6;
      if (_bind$19.$tag === 1) {
        const _ok = _bind$19;
        values$6 = _ok._0;
      ...
      _M0MPC15array5Array14rev__in__placeGsE(values$6);
    ...
    case "lrepeat": {
      ...
      const _bind$20 = _M0FP211localreview3tcl7integer(_M0MPC15array5Array2atGRPB4JsonE(args, 1));
      let count;
      if (_bind$20.$tag === 1) {
        const _ok = _bind$20;
        count = _ok._0;
      ...
      if (count < 0) {
        ...
        _tmp$10 = count > (100000 / _tmp$11 | 0);
      }
      if (_tmp$10) {
      ...
      const values$7 = [];
      const _bind$21 = 0;
      let _tmp$11 = _bind$21;
      while (true) {
        const _ = _tmp$11;
        if (_ < count) {
          const _bind$22 = _M0MPC15array5Array12view_2einnerGsE(args, 2, undefined);
          const _bind$23 = _bind$22.end - _bind$22.start | 0;
          let _tmp$12 = 0;
          while (true) {
            const _$2 = _tmp$12;
            if (_$2 < _bind$23) {
              const value$2 = _bind$22.buf[_bind$22.start + _$2 | 0];
              _M0MPC15array5Array4pushGRPC14json10WriteFrameE(values$7, value$2);
              _tmp$12 = _$2 + 1 | 0;
              continue;
            } else {
              break;
      ...
      return _M0FP211localreview3tcl12format__list(values$7);
    }
    default: {
  ...
  _L: {
    _L$2: {
      _L$3: {
        ...
        const cmp = _M0IPC16string6StringPB7Compare7compare(a$2, b$2);
...
function _M0MP211localreview3tcl11Interpreter18namespace__command(self, args, depth) {
  ...
  _L: {
    ...
    switch (_bind$2) {
      ...
      case "exists": {
        ...
        return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE2Ok(_M0FP211localreview3tcl13boolean__text(_M0MPB3Map8containsGsbE(self.state.namespaces, _M0FP211localreview3tcl15qualified__name(self.frame.namespace_name, _M0MPC15array5Array2atGRPB4JsonE(args, 2)))));
      }
      case "parent": {
        if (n > 3) {
        ...
        const target = n === 3 ? _M0FP211localreview3tcl15qualified__name(self.frame.namespace_name, _M0MPC15array5Array2atGRPB4JsonE(args, 2)) : self.frame.namespace_name;
      ...
      case "tail": {
        ...
        return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE2Ok(_M0FP211localreview3tcl15namespace__tail(_M0MPC15array5Array2atGRPB4JsonE(args, 2)));
      }
      case "qualifiers": {
        if (n !== 3) {
        ...
        const _tmp = _M0MPC15array5Array2atGRPB4JsonE(args, 2);
        const _bind$3 = "::";
        const parts = _M0MPB4Iter9to__arrayGRPC16string10StringViewE(_M0MPC16string6String5split(_tmp, new _M0TPC16string10StringView(_bind$3, 0, _bind$3.length)));
        if (parts.length < 2) {
          return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE2Ok("");
        } else {
          const _tmp$2 = _M0MPC15array9ArrayView9to__ownedGsE(_M0MPC15array5Array12view_2einnerGsE(parts, 0, parts.length - 1 | 0));
          const _bind$4 = "::";
          return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE2Ok(_M0MPC15array5Array4joinGRPC16string10StringViewE(_tmp$2, new _M0TPC16string10StringView(_bind$4, 0, _bind$4.length)));
        }
      }
      case "children": {
        if (n > 4) {
        ...
        const target$2 = n >= 3 ? _M0FP211localreview3tcl15qualified__name(self.frame.namespace_name, _M0MPC15array5Array2atGRPB4JsonE(args, 2)) : self.frame.namespace_name;
        ...
        let _tmp$2;
        if (n === 4) {
          const _bind$4 = _M0MPC15array5Array6filterGsEHRP211localreview3tcl8TclError(names, (name) => {
            let _tmp$3;
            const _tmp$4 = _M0MPC15array5Array2atGRPB4JsonE(args, 3);
            const _bind$5 = "::";
            if (_M0MPC16string6String11has__prefix(_tmp$4, new _M0TPC16string10StringView(_bind$5, 0, _bind$5.length))) {
              _tmp$3 = _M0MPC15array5Array2atGRPB4JsonE(args, 3);
            } else {
              _tmp$3 = _M0FP211localreview3tcl15qualified__name(target$2, _M0MPC15array5Array2atGRPB4JsonE(args, 3));
            }
            return _M0FP211localreview3tcl11glob__match(_tmp$3, name, false);
          });
          if (_bind$4.$tag === 1) {
            const _ok = _bind$4;
            _tmp$2 = _ok._0;
        ...
        return _M0FP211localreview3tcl12format__list(_tmp$2);
      }
      case "which": {
        const variable = n === 4 && _M0MPC15array5Array2atGRPB4JsonE(args, 2) === "-variable";
        let name;
        if (n === 3) {
          name = _M0MPC15array5Array2atGRPB4JsonE(args, 2);
        } else {
          if (n === 4 && (variable || _M0MPC15array5Array2atGRPB4JsonE(args, 2) === "-command")) {
            name = _M0MPC15array5Array2atGRPB4JsonE(args, 3);
          } else {
        ...
        if (variable) {
          ...
          if (!_M0MPC16string6String8contains(name, new _M0TPC16string10StringView(_bind$4, 0, _bind$4.length))) {
            _tmp$3 = !_M0MP211localreview3tcl11Interpreter15global__defined(self, key.val) && _M0MP211localreview3tcl11Interpreter15global__defined(self, `::${name}`);
          } else {
            _tmp$3 = false;
          }
          if (_tmp$3) {
          ...
          return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE2Ok(_M0MPC16option6Option10unwrap__orGsE(_M0MP211localreview3tcl11Interpreter15find__procedure(self, name), _M0FP211localreview3tcl13builtin__name(name) ? _M0FP211localreview3tcl15qualified__name("::", name) : ""));
        }
      }
      case "delete": {
        const _bind$4 = _M0MPC15array5Array12view_2einnerGsE(args, 2, undefined);
        ...
        while (true) {
          ...
          if (_ < _bind$5) {
            ...
            const target$3 = _M0FP211localreview3tcl15qualified__name(self.frame.namespace_name, name$2);
            if (target$3 === "::") {
            ...
            const _bind$6 = _M0MPB4Iter9to__arrayGRPC16string10StringViewE(_M0MPB3Map4keysGsbE(self.state.namespaces));
            const _bind$7 = _bind$6.length;
            let _tmp$4 = 0;
            while (true) {
              const _$2 = _tmp$4;
              if (_$2 < _bind$7) {
                const key = _bind$6[_$2];
                let _tmp$5;
                if (key === target$3) {
                  _tmp$5 = true;
                } else {
                  const _bind$8 = `${target$3}::`;
                  _tmp$5 = _M0MPC16string6String11has__prefix(key, new _M0TPC16string10StringView(_bind$8, 0, _bind$8.length));
                }
                if (_tmp$5) {
            ...
            const _bind$8 = _M0MPB4Iter9to__arrayGRPC16string10StringViewE(_M0MPB3Map4keysGsRP211localreview3tcl4CellE(self.state.globals));
            const _bind$9 = _bind$8.length;
            let _tmp$5 = 0;
            while (true) {
              const _$2 = _tmp$5;
              if (_$2 < _bind$9) {
                const key = _bind$8[_$2];
                const _bind$10 = `${target$3}::`;
                if (_M0MPC16string6String11has__prefix(key, new _M0TPC16string10StringView(_bind$10, 0, _bind$10.length))) {
                  let cell;
                  _L$2: {
                    _L$3: {
                      const _bind$11 = _M0MPB3Map3getGsRP211localreview3tcl4CellE(self.state.globals, key);
            ...
            const _bind$10 = _M0MPB4Iter9to__arrayGRPC16string10StringViewE(_M0MPB3Map4keysGsRP211localreview3tcl4CellE(self.state.procedures));
            const _bind$11 = _bind$10.length;
            let _tmp$6 = 0;
            while (true) {
              const _$2 = _tmp$6;
              if (_$2 < _bind$11) {
                const key = _bind$10[_$2];
                const _bind$12 = `${target$3}::`;
                if (_M0MPC16string6String11has__prefix(key, new _M0TPC16string10StringView(_bind$12, 0, _bind$12.length))) {
                  _M0MPB3Map6removeGsRP211localreview3tcl9ProcedureE(self.state.procedures, key);
                }
                _tmp$6 = _$2 + 1 | 0;
                continue;
              } else {
            ...
            const _bind$12 = _M0MPB4Iter9to__arrayGRPC16string10StringViewE(_M0MPB3Map4keysGsRP211localreview3tcl4CellE(self.state.aliases));
            const _bind$13 = _bind$12.length;
            let _tmp$7 = 0;
            while (true) {
              const _$2 = _tmp$7;
              if (_$2 < _bind$13) {
                const key = _bind$12[_$2];
                const _bind$14 = `${target$3}::`;
      ...
      case "code": {
        ...
        return _M0FP211localreview3tcl12format__list(["::namespace", "inscope", self.frame.namespace_name, _M0MPC15array5Array2atGRPB4JsonE(args, 2)]);
      }
      default: {
  ...
  const target = _M0FP211localreview3tcl15qualified__name(self.frame.namespace_name, _M0MPC15array5Array2atGRPB4JsonE(args, 2));
  if (_M0MPC15array5Array2atGRPB4JsonE(args, 1) === "inscope" && !_M0MPB3Map8containsGsbE(self.state.namespaces, target)) {
    return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid("unknown namespace"));
  }
  const _bind$2 = "::";
  const parts = _M0MPB4Iter9to__arrayGRPC16string10StringViewE(_M0MPB4Iter6filterGRPC16string10StringViewE(_M0MPC16string6String5split(target, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length)), (s) => !_M0MPC16string10StringView9is__empty(s)));
  ...
  const _bind$4 = [];
  const frame = new _M0TP211localreview3tcl5Frame(_M0MPB3Map3MapGsRP211localreview3tcl7BindingE(new _M0TPB9ArrayViewGUsRP211localreview3tcl7BindingEE(_bind$4, 0, 0), undefined), target, false, self.frame);
  const _tmp$2 = _M0MP211localreview3tcl11Interpreter11with__frame(self, frame);
  const _tmp$3 = _M0MPC15array9ArrayView9to__ownedGsE(_M0MPC15array5Array12view_2einnerGsE(args, 3, undefined));
  const _bind$5 = " ";
  return _M0MP211localreview3tcl11Interpreter7execute(_tmp$2, _M0MPC15array5Array4joinGsE(_tmp$3, new _M0TPC16string10StringView(_bind$5, 0, _bind$5.length)), depth + 1 | 0);
}
function _M0MP211localreview3tcl11Interpreter7execute(self, source, depth) {
  ...
  const parser = new _M0TP211localreview3tcl12ScriptParser(_M0MPC16string6String9to__array(source), 0);
  const result = new _M0TPB8MutLocalGsE("");
  while (true) {
    if (parser.pos < parser.chars.length) {
      const _bind$2 = _M0MP211localreview3tcl12ScriptParser14script_2einner(parser, false, 0, true);
      let commands;
      if (_bind$2.$tag === 1) {
        const _ok = _bind$2;
        commands = _ok._0;
      ...
      if (!_M0MPC15array5Array9is__emptyGRPB5ArrayGRP211localreview3tcl4WordEE(commands)) {
        const _bind$3 = _M0MP211localreview3tcl11Interpreter17execute__commands(self, commands, depth);
        let _tmp;
        if (_bind$3.$tag === 1) {
          const _ok = _bind$3;
          _tmp = _ok._0;
...
function _M0MP211localreview3tcl11Interpreter17execute__commands(self, commands, depth) {
  if (depth > 64) {
  ...
  while (true) {
    const _ = _tmp;
    if (_ < _bind$2) {
      const words = commands[_];
      const args = [];
      const _bind$3 = words.length;
      let _tmp$2 = 0;
      while (true) {
        const _$2 = _tmp$2;
        if (_$2 < _bind$3) {
          const word = words[_$2];
          const _bind$4 = _M0MP211localreview3tcl11Interpreter13expand__parts(self, word.parts, depth + 1 | 0);
          let value;
          if (_bind$4.$tag === 1) {
            const _ok = _bind$4;
            value = _ok._0;
          ...
          if (word.expand) {
            const _bind$5 = _M0FP211localreview3tcl11parse__list(value);
            let _bind$6;
            if (_bind$5.$tag === 1) {
              const _ok = _bind$5;
              _bind$6 = _ok._0;
          ...
          if (args.length > 4096) {
            return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid("expanded argument limit"));
          }
          _tmp$2 = _$2 + 1 | 0;
          continue;
        } else {
      ...
      if (!_M0MPC15array5Array9is__emptyGRPB4JsonE(args)) {
        const _bind$4 = _M0MP211localreview3tcl11Interpreter7command(self, args, depth);
        let _tmp$3;
        if (_bind$4.$tag === 1) {
          const _ok = _bind$4;
          _tmp$3 = _ok._0;
      ...
      if (result.val.length > 1000000) {
        return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid("command result size limit"));
      }
      _tmp = _ + 1 | 0;
      continue;
    } else {
...
function _M0MP211localreview3tcl11Interpreter7command(self, input, depth) {
  const _bind$2 = _M0MP211localreview3tcl11Interpreter4tick(self);
  if (_bind$2.$tag === 1) {
    const _ok = _bind$2;
    _ok._0;
  } else {
  ...
  _L: {
    _L$2: {
      const _bind$3 = _M0MP211localreview3tcl11Interpreter15find__procedure(self, _M0MPC15array5Array2atGRPB4JsonE(input, 0));
      if (_bind$3 === undefined) {
      } else {
        const _Some = _bind$3;
        const _key = _Some;
    ...
    const _bind$3 = _M0MP211localreview3tcl11Interpreter17invoke__procedure(self, _M0IPC15array5ArrayPB3Add3addGsE([key], _M0MPC15array9ArrayView9to__ownedGsE(_M0MPC15array5Array12view_2einnerGsE(input, 1, undefined))), depth);
    let _tmp;
    if (_bind$3.$tag === 1) {
      const _ok = _bind$3;
      _tmp = _ok._0;
  ...
  const args = _M0MPC15array5Array4copyGsE(input);
  const _tmp = _M0MPC15array5Array2atGRPB4JsonE(args, 0);
  const _bind$3 = "::";
  if (_M0MPC16string6String11has__prefix(_tmp, new _M0TPC16string10StringView(_bind$3, 0, _bind$3.length))) {
    _M0MPC15array5Array3setGsE(args, 0, _M0MPC16string10StringView9to__owned(_M0MPC16string6String11sub_2einner(_M0MPC15array5Array2atGRPB4JsonE(args, 0), 2, undefined)));
  }
  const n = args.length;
  _L$2: {
    _L$3: {
      _L$4: {
        _L$5: {
          const _bind$4 = _M0MPC15array5Array2atGRPB4JsonE(args, 0);
          switch (_bind$4) {
            case "list": {
              break _L$5;
            }
            ...
            case "namespace": {
              return _M0MP211localreview3tcl11Interpreter18namespace__command(self, args, depth);
            }
            case "global": {
              break _L$2;
            }
            ...
            case "array": {
              return _M0MP211localreview3tcl11Interpreter14array__command(self, args);
            }
            case "dict": {
              return _M0MP211localreview3tcl11Interpreter13dict__command(self, args, depth);
            }
            case "string": {
              return _M0MP211localreview3tcl11Interpreter15string__command(self, args);
            }
            case "info": {
              return _M0MP211localreview3tcl11Interpreter13info__command(self, args);
            }
            case "set": {
              if (n === 2) {
                return _M0MP211localreview3tcl11Interpreter9read__var(self, _M0MPC15array5Array2atGRPB4JsonE(args, 1));
              } else {
                if (n === 3) {
                  const _bind$5 = _M0MP211localreview3tcl11Interpreter8set__var(self, _M0MPC15array5Array2atGRPB4JsonE(args, 1), _M0MPC15array5Array2atGRPB4JsonE(args, 2));
                  if (_bind$5.$tag === 1) {
                    const _ok = _bind$5;
                    _ok._0;
                  } else {
            ...
            case "unset": {
              ...
              const _bind$5 = _M0MPC15array5Array12view_2einnerGsE(args, i.val, undefined);
              const _bind$6 = _bind$5.end - _bind$5.start | 0;
              let _tmp$2 = 0;
              while (true) {
                const _ = _tmp$2;
                if (_ < _bind$6) {
                  const name = _bind$5.buf[_bind$5.start + _ | 0];
                  const _bind$7 = _M0MP211localreview3tcl11Interpreter10unset__var(self, name, quiet.val);
                  if (_bind$7.$tag === 1) {
                    const _ok = _bind$7;
                    _ok._0;
                  } else {
            ...
            case "incr": {
              ...
              const _bind$7 = _M0MP211localreview3tcl11Interpreter8get__var(self, _M0MPC15array5Array2atGRPB4JsonE(args, 1));
              let _tmp$3;
              if (_bind$7.$tag === 1) {
                const _ok = _bind$7;
                _tmp$3 = _ok._0;
              ...
              const _bind$8 = _M0FP211localreview3tcl5whole(_M0MPC16option6Option10unwrap__orGsE(_tmp$3, "0"));
              let _tmp$4;
              if (_bind$8.$tag === 1) {
                const _ok = _bind$8;
                _tmp$4 = _ok._0;
              ...
              const _tmp$5 = _tmp$4;
              const _bind$9 = _M0FP211localreview3tcl5whole(n === 3 ? _M0MPC15array5Array2atGRPB4JsonE(args, 2) : "1");
              let _tmp$6;
              if (_bind$9.$tag === 1) {
                const _ok = _bind$9;
                _tmp$6 = _ok._0;
              ...
              const value = _M0IPC16bigint6BigIntPB3Add3add(_tmp$5, _tmp$6);
              const _bind$10 = _M0MP211localreview3tcl6Number4text(new _M0DTP211localreview3tcl6Number5Whole(value));
              let text;
              if (_bind$10.$tag === 1) {
                const _ok = _bind$10;
                text = _ok._0;
              ...
              const _bind$11 = _M0MP211localreview3tcl11Interpreter8set__var(self, _M0MPC15array5Array2atGRPB4JsonE(args, 1), text);
              if (_bind$11.$tag === 1) {
                const _ok = _bind$11;
                _ok._0;
              } else {
            ...
            case "append": {
              ...
              const _bind$12 = _M0MP211localreview3tcl11Interpreter8get__var(self, _M0MPC15array5Array2atGRPB4JsonE(args, 1));
              let _tmp$7;
              if (_bind$12.$tag === 1) {
                const _ok = _bind$12;
                _tmp$7 = _ok._0;
              ...
              const _bind$14 = "";
              const result = _M0MPC15array5Array4joinGsE(values, new _M0TPC16string10StringView(_bind$14, 0, _bind$14.length));
              const _bind$15 = _M0MP211localreview3tcl11Interpreter8set__var(self, _M0MPC15array5Array2atGRPB4JsonE(args, 1), result);
              if (_bind$15.$tag === 1) {
                const _ok = _bind$15;
                _ok._0;
              } else {
            ...
            case "expr": {
              ...
              const _bind$16 = " ";
              return _M0MP211localreview3tcl11Interpreter17expression__value(self, _M0MPC15array5Array4joinGsE(_tmp$9, new _M0TPC16string10StringView(_bind$16, 0, _bind$16.length)), depth);
            }
            case "puts": {
              ...
              let value$2;
              if (n === (start + 1 | 0)) {
                value$2 = _M0MPC15array5Array2atGRPB4JsonE(args, start);
              } else {
                if (n === (start + 2 | 0) && _M0MPC15array5Array2atGRPB4JsonE(args, start) === "stdout") {
                  value$2 = _M0MPC15array5Array2atGRPB4JsonE(args, start + 1 | 0);
                } else {
              ...
              const text$2 = `${value$2}${nonewline ? "" : "\n"}`;
              if (text$2.length > (1000000 - _M0MPC15array5Array2atGiE(self.output_size, 0) | 0)) {
            ...
            case "if": {
              ...
              while (true) {
                if (i$2.val < n) {
                  ...
                  i$2.val = i$2.val + 1 | 0;
                  const _bind$17 = _M0MP211localreview3tcl11Interpreter17expression__value(self, expression, depth);
                  let _tmp$10;
                  if (_bind$17.$tag === 1) {
                    const _ok = _bind$17;
                    _tmp$10 = _ok._0;
                  ...
                  const _bind$18 = _M0FP211localreview3tcl7boolean(_tmp$10);
                  let _tmp$11;
                  if (_bind$18.$tag === 1) {
                    const _ok = _bind$18;
                    _tmp$11 = _ok._0;
                  ...
                  if (_tmp$11) {
                    const _bind$19 = _M0MP211localreview3tcl11Interpreter7execute(self, body, depth + 1 | 0);
                    let _tmp$12;
                    if (_bind$19.$tag === 1) {
                      const _ok = _bind$19;
                      _tmp$12 = _ok._0;
                  ...
                  const _bind$19 = _M0MP211localreview3tcl11Interpreter7execute(self, _M0MPC15array5Array2atGRPB4JsonE(args, i$2.val), depth + 1 | 0);
                  let _tmp$12;
                  if (_bind$19.$tag === 1) {
                    const _ok = _bind$19;
                    _tmp$12 = _ok._0;
            ...
            case "proc": {
              ...
              const key$2 = _M0FP211localreview3tcl15qualified__name(self.frame.namespace_name, _M0MPC15array5Array2atGRPB4JsonE(args, 1));
              const owner = _M0FP211localreview3tcl17namespace__parent(key$2);
              ...
              const parameters = [];
              const _bind$17 = _M0FP211localreview3tcl11parse__list(_M0MPC15array5Array2atGRPB4JsonE(args, 2));
              let _bind$18;
              if (_bind$17.$tag === 1) {
                const _ok = _bind$17;
                _bind$18 = _ok._0;
              ...
              while (true) {
                const _ = _tmp$10;
                if (_ < _bind$19) {
                  const spec = _bind$18[_];
                  const _bind$20 = _M0FP211localreview3tcl11parse__list(spec);
                  let parts;
                  if (_bind$20.$tag === 1) {
                    const _ok = _bind$20;
                    parts = _ok._0;
              ...
              _M0MPB3Map3setGsRP211localreview3tcl9ProcedureE(self.state.procedures, key$2, new _M0TP211localreview3tcl9Procedure(parameters, _M0MPC15array5Array2atGRPB4JsonE(args, 3), owner));
              return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE2Ok("");
            }
            case "return": {
              if (n > 2) {
                return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid("return options not implemented"));
              }
              return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error37localreview_2ftcl_2eTclError_2eReturn(n === 2 ? _M0MPC15array5Array2atGRPB4JsonE(args, 1) : ""));
            }
            case "eval": {
              if (n < 2) {
              ...
              const _bind$20 = " ";
              return _M0MP211localreview3tcl11Interpreter7execute(self, _M0MPC15array5Array4joinGsE(_tmp$11, new _M0TPC16string10StringView(_bind$20, 0, _bind$20.length)), depth + 1 | 0);
            }
            case "subst": {
              if (n !== 2) {
              ...
              const parser = new _M0TP211localreview3tcl12ScriptParser(_M0MPC16string6String9to__array(_M0MPC15array5Array2atGRPB4JsonE(args, 1)), 0);
              const _bind$21 = _M0MP211localreview3tcl12ScriptParser13parts_2einner(parser, 0, false, 0, false);
              let _tmp$12;
              if (_bind$21.$tag === 1) {
                const _ok = _bind$21;
                _tmp$12 = _ok._0;
              ...
              return _M0MP211localreview3tcl11Interpreter13expand__parts(self, _tmp$12, depth + 1 | 0);
            }
            case "rename": {
              if (n !== 3) {
              ...
              const key$3 = _M0MPC16option6Option10unwrap__orGsE(_M0MP211localreview3tcl11Interpreter15find__procedure(self, _M0MPC15array5Array2atGRPB4JsonE(args, 1)), "");
              if (_M0MPC16string6String9is__empty(key$3)) {
                return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid("only user procedures can be renamed"));
              }
              const definition = _M0MPC16option6Option6unwrapGRPB5EntryGiRP211localreview3tcl11InterpreterEE(_M0MPB3Map3getGsRP211localreview3tcl9ProcedureE(self.state.procedures, key$3));
              if (!_M0MPC16string6String9is__empty(_M0MPC15array5Array2atGRPB4JsonE(args, 2))) {
                const target = _M0FP211localreview3tcl15qualified__name(self.frame.namespace_name, _M0MPC15array5Array2atGRPB4JsonE(args, 2));
                if (_M0MPB3Map8containsGsRP211localreview3tcl9ProcedureE(self.state.procedures, target)) {
                ...
                const destination = _M0FP211localreview3tcl17namespace__parent(target);
                if (!_M0MPB3Map8containsGsbE(self.state.namespaces, destination)) {
                ...
                _M0MPB3Map3setGsRP211localreview3tcl9ProcedureE(self.state.procedures, target, new _M0TP211localreview3tcl9Procedure(definition.parameters, definition.body, destination));
              }
              _M0MPB3Map6removeGsRP211localreview3tcl9ProcedureE(self.state.procedures, key$3);
              return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE2Ok("");
            }
            default: {
        ...
        return _M0MP211localreview3tcl11Interpreter13list__command(self, args);
      }
      return _M0MP211localreview3tcl11Interpreter23extended__list__command(self, args, depth);
    }
    return _M0MP211localreview3tcl11Interpreter16control__command(self, args, depth);
  }
  return _M0MP211localreview3tcl11Interpreter14scope__command(self, args, depth);
}
function _M0MP211localreview3tcl11Interpreter16control__command(self, args, depth) {
  ...
  _L: {
    ...
    switch (_bind$2) {
      ...
      case "error": {
        ...
        return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid(_M0MPC15array5Array2atGRPB4JsonE(args, 1)));
      }
      case "catch": {
        if (n !== 2 && n !== 3) {
        ...
        _L$2: {
          let _try_err;
          _L$3: {
            const _bind$3 = _M0MP211localreview3tcl11Interpreter7execute(self, _M0MPC15array5Array2atGRPB4JsonE(args, 1), depth + 1 | 0);
            let _tmp;
            if (_bind$3.$tag === 1) {
              const _ok = _bind$3;
              _tmp = _ok._0;
            ...
            _L$5: {
              switch (_try_err.$tag) {
                case 3: {
                  ...
                  const _v = _Invalid._0;
                  v$2 = _v;
                  break _L$5;
                }
                case 2: {
                  const _Return = _try_err;
        ...
        return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE2Ok(_M0MPC13int3Int18to__string_2einner(code, 10));
      }
      case "while": {
        if (n !== 3) {
    ...
    if (iteration < _bind$3) {
      _L$3: {
        ...
        if (_M0MPC15array5Array2atGRPB4JsonE(args, 0) === "lmap") {
          ...
          _L$4: {
            _L$5: {
              const _bind$6 = _M0MP211localreview3tcl11Interpreter7execute(self, _M0MPC15array5Array2atGRPB4JsonE(args, n - 1 | 0), depth + 1 | 0);
              let _tmp$4;
              if (_bind$6.$tag === 1) {
                const _ok = _bind$6;
                _tmp$4 = _ok._0;
            ...
            _L$6: {
              ...
              _L$7: {
                switch (_try_err.$tag) {
                  ...
                  default: {
                    const _Invalid = _try_err;
                    const _v$2 = _Invalid._0;
                    v = _v$2;
                    break _L$6;
                  }
                }
              }
              return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error37localreview_2ftcl_2eTclError_2eReturn(v$2));
            }
            return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid(v));
          }
        } else {
  ...
  return _M0MPC15array5Array2atGRPB4JsonE(args, 0) === "lmap" ? _M0FP211localreview3tcl12format__list(collected) : new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE2Ok("");
}
function _M0MP211localreview3tcl11Interpreter10loop__body(self, source, depth) {
  let _try_err;
  _L: {
    const _bind$2 = _M0MP211localreview3tcl11Interpreter7execute(self, source, depth + 1 | 0);
    if (_bind$2.$tag === 1) {
      const _ok = _bind$2;
      _ok._0;
    } else {
  ...
  _L$2: {
    ...
    return new _M0DTPC16result6ResultGiRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error37localreview_2ftcl_2eTclError_2eReturn(v$2));
  }
  return new _M0DTPC16result6ResultGiRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid(v));
}
...
function _M0MP211localreview3tcl11Interpreter17expression__value(self, source, depth) {
  ...
  if (parser.pos !== parser.chars.length) {
    return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid("trailing expression token"));
  }
  ...
  while (true) {
    ...
    if (_ < _bind$2) {
      ...
      _L: {
        ...
        const _bind$4 = _M0MP211localreview3tcl11Interpreter17execute__commands(self, commands, depth + 1 | 0);
        if (_bind$4.$tag === 1) {
          const _ok = _bind$4;
          value = _ok._0;
        } else {
...
function _M0MP211localreview3tcl11Interpreter14math__function(self, name, args, depth) {
  ...
  _L: {
    _L$2: {
      const _bind$2 = _M0MP211localreview3tcl11Interpreter15find__procedure(self, `tcl::mathfunc::${name}`);
      if (_bind$2 === undefined) {
      } else {
        const _Some = _bind$2;
        const _key = _Some;
    ...
    const _bind$2 = _M0MP211localreview3tcl11Interpreter17invoke__procedure(self, _M0IPC15array5ArrayPB3Add3addGsE([key], args), depth);
    let _tmp;
    if (_bind$2.$tag === 1) {
      const _ok = _bind$2;
      _tmp = _ok._0;
  ...
  if (_M0MPC15array5Array8containsGsE(["int", "wide", "entier", "round"], name)) {
    ...
    if (name === "int" || name === "wide") {
      ...
      const _bind$4 = _M0MP211localreview3tcl6Number4text(new _M0DTP211localreview3tcl6Number5Whole(_M0IP016_24default__implPB7Compare6op__geGRPC16bigint6BigIntE(masked, _M0IPC16bigint6BigIntPB3Shl3shl(1n, 63)) ? _M0IPC16bigint6BigIntPB3Sub3sub(masked, modulus) : masked));
      let _tmp;
      if (_bind$4.$tag === 1) {
        const _ok = _bind$4;
        _tmp = _ok._0;
    ...
    const _bind$4 = _M0MP211localreview3tcl6Number4text(new _M0DTP211localreview3tcl6Number5Whole(n));
    let _tmp;
    if (_bind$4.$tag === 1) {
      const _ok = _bind$4;
      _tmp = _ok._0;
...
function _M0MP211localreview3tcl11Interpreter17invoke__procedure(self, args, depth) {
  let definition;
  const _bind$2 = _M0MPB3Map3getGsRP211localreview3tcl9ProcedureE(self.state.procedures, _M0MPC15array5Array2atGRPB4JsonE(args, 0));
  if (_bind$2 === undefined) {
    return new _M0DTPC16result6ResultGsRP211localreview3tcl8TclErrorE3Err(new _M0DTPC15error5Error38localreview_2ftcl_2eTclError_2eInvalid("procedure missing"));
  } else {
    const _Some = _bind$2;
    const _p = _Some;
    definition = _p;
  ...
  while (true) {
    const i = _tmp;
    if (i < fixed) {
      const _bind$4 = _M0MPC15array5Array2atGRPB4JsonE(parameters, i)._1;
      if (_bind$4 === undefined) {
        required.val = i + 1 | 0;
      }
      _tmp = i + 1 | 0;
  ...
  const _bind$4 = [];
  const vars = _M0MPB3Map3MapGssE(new _M0TPB9ArrayViewGUssEE(_bind$4, 0, 0), undefined);
  const _bind$5 = 0;
  let _tmp$2 = _bind$5;
  while (true) {
    const i = _tmp$2;
    if (i < fixed) {
      ...
      let default_;
      _L: {
        const _bind$6 = _M0MPC15array5Array2atGRPB4JsonE(parameters, i);
  ...
  if (variadic && !_M0MPB3Map8containsGssE(vars, "args")) {
    const _bind$6 = _M0FP211localreview3tcl12format__list(supplied > fixed ? _M0MPC15array9ArrayView9to__ownedGsE(_M0MPC15array5Array12view_2einnerGsE(args, fixed + 1 | 0, undefined)) : []);
    let _tmp$3;
    if (_bind$6.$tag === 1) {
      const _ok = _bind$6;
      _tmp$3 = _ok._0;
  ...
  const _bind$6 = [];
  const bindings = _M0MPB3Map3MapGsRP211localreview3tcl7BindingE(new _M0TPB9ArrayViewGUsRP211localreview3tcl7BindingEE(_bind$6, 0, 0), undefined);
  const _it = _M0MPB3Map5iter2GssE(vars);
  while (true) {
    let name;
    let value;
    _L: {
      const _bind$7 = _M0MPB5Iter24nextGssE(_it);
  ...
  let _try_err;
  _L: {
    const _bind$7 = _M0MP211localreview3tcl11Interpreter7execute(child, body, depth + 1 | 0);
    let _tmp$3;
    if (_bind$7.$tag === 1) {
      const _ok = _bind$7;
      _tmp$3 = _ok._0;
...
function _M0MP211localreview3tcl11Interpreter13dict__command(self, args, depth) {
  const n = args.length;
  if (n < 2) {
  ...
  _L: {
          ...
          _L$5: {
            ...
            switch (_bind$2) {
                    ...
                    _L$9: {
                      ...
                      if (_M0MPC15array5Array2atGRPB4JsonE(args, 3) === "key" || _M0MPC15array5Array2atGRPB4JsonE(args, 3) === "value") {
                        ...
                        if (_M0MPC15array5Array2atGRPB4JsonE(args, 3) === "script" && n === 6) {
                          ...
                          _L$10: {
                            _L$11: {
                              const _bind$16 = _M0MP211localreview3tcl11Interpreter7execute(self, _M0MPC15array5Array2atGRPB4JsonE(args, 5), depth + 1 | 0);
                              let _tmp$7;
                              if (_bind$16.$tag === 1) {
                                const _ok = _bind$16;
                                _tmp$7 = _ok._0;
              ...
              case "update": {
                ...
                let _err;
                _L$8: {
                  const _bind$14 = _M0MP211localreview3tcl11Interpreter7execute(self, _M0MPC15array5Array2atGRPB4JsonE(args, n - 1 | 0), depth + 1 | 0);
                  let _defer_result;
                  if (_bind$14.$tag === 1) {
                    const _ok = _bind$14;
              ...
              case "with": {
                ...
                let _err$2;
                _L$9: {
                  const _bind$19 = _M0MP211localreview3tcl11Interpreter7execute(self, _M0MPC15array5Array2atGRPB4JsonE(args, n - 1 | 0), depth + 1 | 0);
                  let _defer_result;
                  if (_bind$19.$tag === 1) {
                    const _ok = _bind$19;
                    _defer_result = _ok._0;
    ...
    if (_M0MPC15array5Array2atGRPB4JsonE(args, 1) === "incr") {
      ...
      const _bind$5 = _M0FP211localreview3tcl5whole(exists ? current : "0");
      let _tmp$3;
      if (_bind$5.$tag === 1) {
        const _ok = _bind$5;
        _tmp$3 = _ok._0;
      ...
      const _tmp$4 = _tmp$3;
      const _bind$6 = _M0FP211localreview3tcl5whole(n === 5 ? _M0MPC15array5Array2atGRPB4JsonE(args, 4) : "1");
      let _tmp$5;
      if (_bind$6.$tag === 1) {
        const _ok = _bind$6;
        _tmp$5 = _ok._0;
      ...
      const _bind$7 = _M0MP211localreview3tcl6Number4text(new _M0DTP211localreview3tcl6Number5Whole(_M0IPC16bigint6BigIntPB3Add3add(_tmp$4, _tmp$5)));
      if (_bind$7.$tag === 1) {
        const _ok = _bind$7;
        value = _ok._0;
      } else {
  ...
  _L$2: while (true) {
    ...
    if (_ < _bind$5) {
      ...
      _L$4: {
        ...
        _L$5: {
          _L$6: {
            const _bind$9 = _M0MP211localreview3tcl11Interpreter7execute(self, _M0MPC15array5Array2atGRPB4JsonE(args, 4), depth + 1 | 0);
            let computed;
            if (_bind$9.$tag === 1) {
              const _ok = _bind$9;
              computed = _ok._0;
        ...
        _L: {
          _L$2: {
            ...
            if (_bind$18 === undefined) {
              if (mode.val === "-integer") {
                const _bind$19 = _M0FP211localreview3tcl5whole(a$2);
                let _tmp$6;
                if (_bind$19.$tag === 1) {
                  const _ok = _bind$19;
                  _tmp$6 = _ok._0;
                ...
                const _tmp$7 = _tmp$6;
                const _bind$20 = _M0FP211localreview3tcl5whole(b$2);
                let _tmp$8;
                if (_bind$20.$tag === 1) {
                  const _ok = _bind$20;
                  _tmp$8 = _ok._0;
                ...
                result$3 = _M0IPC16bigint6BigIntPB7Compare7compare(_tmp$7, _tmp$8);
              } else {
                if (mode.val === "-real") {
                  let a$3;
                  let n$2;
                  ...
                  result$3 = _M0IPC16string6StringPB7Compare7compare(a$2, b$2);
                }
              }
            } else {
          ...
          const _bind$19 = _M0MP211localreview3tcl11Interpreter7command(self, _M0IPC15array5ArrayPB3Add3addGsE(_tmp$6, [a$2, b$2]), depth + 1 | 0);
          let _tmp$7;
          if (_bind$19.$tag === 1) {
            const _ok = _bind$19;
            _tmp$7 = _ok._0;
  ...
  _L: {
    ...
    switch (_bind$2) {
      ...
      case "uplevel": {
        ...
        const _bind$6 = " ";
        return _M0MP211localreview3tcl11Interpreter7execute(_tmp$5, _M0MPC15array5Array4joinGsE(_tmp$6, new _M0TPC16string10StringView(_bind$6, 0, _bind$6.length)), depth + 1 | 0);
      }
      default: {
...
function _M0MP211localreview3tcl11Interpreter3new() {
  const _bind$2 = [];
  const _tmp = _M0MPB3Map3MapGsRP211localreview3tcl4CellE(new _M0TPB9ArrayViewGUsRP211localreview3tcl4CellEE(_bind$2, 0, 0), undefined);
  const _bind$3 = [];
  const _tmp$2 = _M0MPB3Map3MapGsRP211localreview3tcl7BindingE(new _M0TPB9ArrayViewGUsRP211localreview3tcl7BindingEE(_bind$3, 0, 0), undefined);
  const _bind$4 = [];
  const _tmp$3 = _M0MPB3Map3MapGsRP211localreview3tcl9ProcedureE(new _M0TPB9ArrayViewGUsRP211localreview3tcl9ProcedureEE(_bind$4, 0, 0), undefined);
  const _bind$5 = [{ _0: "::", _1: true }];
  const _tmp$4 = new _M0TP211localreview3tcl5State(_tmp, _tmp$2, _tmp$3, _M0MPB3Map3MapGsbE(new _M0TPB9ArrayViewGUsbEE(_bind$5, 0, 1), undefined));
  const _bind$6 = [];
  return new _M0TP211localreview3tcl11Interpreter(_tmp$4, new _M0TP211localreview3tcl5Frame(_M0MPB3Map3MapGsRP211localreview3tcl7BindingE(new _M0TPB9ArrayViewGUsRP211localreview3tcl7BindingEE(_bind$6, 0, 0), undefined), "::", false, undefined), [], [0], _M0MPC13ref3Ref3RefGiE(10000));
}
...
function _M0MP211localreview3tcl11Interpreter12eval_2einner(self, source, budget) {
  ...
  let _try_err;
  _L: {
    const _bind$2 = _M0MP211localreview3tcl11Interpreter7execute(self, source, 0);
    let _tmp;
    if (_bind$2.$tag === 1) {
      const _ok = _bind$2;
      _tmp = _ok._0;
...
function _M0FP411localreview3tcl3cmd3web21evaluate__interpreter(t, input) {
  ...
  const _bind$2 = [{ _0: "ok", _1: _M0MPC14json4Json7boolean(false) }, { _0: "error", _1: _M0MPC14json4Json6string(_M0IP016_24default__implPB4Show10to__stringGRPC15debug4ReprE(_M0MPC15debug4Repr4ReprGRP211localreview3tcl8TclErrorE(error))) }, { _0: "output", _1: _M0MPC14json4Json6string(_M0MP211localreview3tcl11Interpreter12output__text(t)) }];
